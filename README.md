...
This is a Helm Chart for deploying `hp-ams` in an Openshift cluster (v4.14) that is running over an HPE iLO 6 baremetal infrastructure using a `DaemonSet`. This chart includes optional configurations for RBAC, SecurityContextConstraints (SCC), and other customizations.
